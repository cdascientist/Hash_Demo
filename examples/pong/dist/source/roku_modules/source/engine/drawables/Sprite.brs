...
function __BGE_SpriteAnimation_builder()
    ...
    instance.new = function(name as string, frameList as object, frameRate as integer, playMode = "loop" as string) as void
        m.name = invalid
        m.frameRate = invalid
        m.frameList = invalid
        m.playMode = "loop"
    ...
    instance.setFrameList = function(frameList as object) as void
        m.frameList = []
...
function __BGE_Sprite_builder()
    ...
    instance.setCellRegions = function() as void
    ...
    ' @param {float} x
    ' @param {float} y
    instance.applyPreTranslation = function(x as float, y as float) as void
    ...
    instance.playAnimation = function(animationName as string) as void
